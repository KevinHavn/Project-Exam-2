...
const EditProfileModal = ({ user, onClose }) => {
  ...
  const handleChange = (e) => {
    ...
    if (type === "checkbox") {
      ...
      setFormData((prevFormData) => ({
        ...prevFormData,
        [name.split(".")[0]]: { ...prevFormData[name.split(".")[0]], [field]: value },
      }));
    } else {
      setFormData((prevFormData) => ({
        ...prevFormData,
  ...
  return (
    <Modal onClose={onClose}>
      <form onSubmit={handleSubmit} className="bg-white p-4 shadow-md rounded-md">
        ...
        <div className="mb-4">
          <label htmlFor="avatarUrl" className="block text-gray-700 font-bold mb-2">
            Avatar URL
          </label>
          <input
            type="url"
        ...
        <div className="mb-4">
          <label htmlFor="avatarAlt" className="block text-gray-700 font-bold mb-2">
            Avatar Alt Text
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label htmlFor="bannerUrl" className="block text-gray-700 font-bold mb-2">
            Banner URL
          </label>
          <input
            type="url"
        ...
        <div className="mb-4">
          <label htmlFor="bannerAlt" className="block text-gray-700 font-bold mb-2">
            Banner Alt Text
          </label>
          <input
            type="text"
